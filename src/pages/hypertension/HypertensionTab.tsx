  ...
  const sections = [
    {
      ...
      icon: <BookOpen />,
      description: "AHA 2025 classification, definitions, and diagnostic criteria",
    ...
    },
    {
      ...
      icon: <Stethoscope />,
      description: "BP classification (AHA 2025), GFR calculator, drug interactions, and risk stratification",
