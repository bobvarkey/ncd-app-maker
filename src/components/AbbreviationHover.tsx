...
const ABBREVIATIONS: Record<string, string> = {
  ...
  "TPO": "Thyroid Peroxidase — enzyme in thyroid hormone synthesis; anti-TPO antibodies indicate autoimmune thyroid disease (Hashimoto, Graves)",
  "TRAb": "TSH Receptor Antibody — autoantibody that stimulates or blocks the TSH receptor; positive in Graves disease",
